...
class UnSaturatedOilCorrelationAggregator(CorrelationAggregator):
    _oil_model: OilPhaseCorrelationAggregator

    fvf: VolumeFactorCorrelation = Field(
        title="",
        alias="fvf",
        default=correlation.oil.unsaturated.volume_factor.FamousCorrelation.vasquez_beggs.get(),
    )
    vis: ViscosityCorrelation = Field(
        title="",
        alias="vis",
        default=correlation.oil.unsaturated.viscosity.FamousCorrelation.no_viscosibility.get(),
    )
    bpp: BubblePointPressureCorrelation = Field(
        title="",
        alias="bpp",
        default=correlation.oil.unsaturated.bubble_point_pressure.FamousCorrelation.beggs.get(),
    )
